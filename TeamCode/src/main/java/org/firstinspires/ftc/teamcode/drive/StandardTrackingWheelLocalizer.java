...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 0.9173; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -2.77; // in; offset of the lateral wheel
